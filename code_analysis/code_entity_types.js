...
(function () {
    ...
    const LoopTypeByNode = new Map([
        ["ForStatement", code_analysis.LoopType.FOR_LOOP],
        ["EnhancedForStatement", code_analysis.LoopType.ENHANCED_FOR_LOOP],
        ["WhileStatement", code_analysis.LoopType.WHILE_LOOP],
        ["DoStatement", code_analysis.LoopType.DO_WHILE_LOOP]
    ]);

    this.LoopTypeByNode = LoopTypeByNode;
