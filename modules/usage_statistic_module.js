...
let usage_statistic_module = {};

(function () {

    class Options {
        /**
         * Build options for usage statistics.
         ...
         * @param reportUserStats 
         * @param trackClicks  flag for tracking clicks
         * @param trackScreenTime flag for tracking screen time
         * @param databaseKey
         */
    ...
    */
     ...
     */
    this.initialize = function (uiPanel, options, gradersName) {
        if (!options.enabled) {
            return;
        }
