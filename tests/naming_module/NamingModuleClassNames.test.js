...
test("NamingModuleClassNames_Simple", () => {
    ...
    codeFileDictionary.set("file1", new CodeFile("file1", javaSourceFile1,
        testing_utilities.generateTrCodeLines(javaSourceFile1), JavaParser.parse(javaSourceFile1), null));
    const javaSourceFile2 = multiline(() => {/*
        public class camelCaseName {
        }
        */
    });
    codeFileDictionary.set("file2", new CodeFile("file2", javaSourceFile2,
        testing_utilities.generateTrCodeLines(javaSourceFile2), JavaParser.parse(javaSourceFile2), null));
    const javaSourceFile3 = multiline(() => {/*
        public class UPPER_SNAKE_CASE_NAME {
        }
        */
    });
    codeFileDictionary.set("file3", new CodeFile("file13", javaSourceFile3,
        testing_utilities.generateTrCodeLines(javaSourceFile3), JavaParser.parse(javaSourceFile3), null));
